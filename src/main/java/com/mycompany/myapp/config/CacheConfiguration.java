...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.Location.class.getName() + ".songs");
            createCache(cm, com.mycompany.myapp.domain.Artist.class.getName());
            createCache(cm, com.mycompany.myapp.domain.Artist.class.getName() + ".songs");
            ...
            createCache(cm, com.mycompany.myapp.domain.Song.class.getName() + ".artists");
