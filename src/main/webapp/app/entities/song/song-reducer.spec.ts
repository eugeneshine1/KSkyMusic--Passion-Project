...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './song.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SONG_LIST actions', async () => {
    ...
    it('dispatches FETCH_SONG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SONG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SONG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SONG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SONG actions', async () => {
      const expectedActions = [
        {
