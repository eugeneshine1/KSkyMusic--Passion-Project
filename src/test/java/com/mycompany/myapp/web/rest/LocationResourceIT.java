...
class LocationResourceIT {
    ...
    private static final WeatherType DEFAULT_WEATHER_TYPE = WeatherType.SUNNY;
    private static final WeatherType UPDATED_WEATHER_TYPE = WeatherType.RAINY;
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location()
            ...
            .weatherType(DEFAULT_WEATHER_TYPE);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location()
            ...
            .weatherType(UPDATED_WEATHER_TYPE);
        return location;
    }
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getWeatherType()).isEqualTo(DEFAULT_WEATHER_TYPE);
    }
    ...
    @Test
    @Transactional
    void checkWeatherTypeIsRequired() throws Exception {
        int databaseSizeBeforeTest = locationRepository.findAll().size();
        // set the field null
        location.setWeatherType(null);
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].weatherType").value(hasItem(DEFAULT_WEATHER_TYPE.toString())));
    }
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.weatherType").value(DEFAULT_WEATHER_TYPE.toString()));
    }
    ...
    void putNewLocation() throws Exception {
        ...
        assertThat(testLocation.getWeatherType()).isEqualTo(UPDATED_WEATHER_TYPE);
    }
