...
class AlbumResourceIT {
    ...
    public static Album createEntity(EntityManager em) {
        Album album = new Album().songType(DEFAULT_SONG_TYPE).title(DEFAULT_TITLE).timeDuration(DEFAULT_TIME_DURATION);
        return album;
    }
    ...
    public static Album createUpdatedEntity(EntityManager em) {
        Album album = new Album().songType(UPDATED_SONG_TYPE).title(UPDATED_TITLE).timeDuration(UPDATED_TIME_DURATION);
        return album;
    }
    ...
    void createAlbum() throws Exception {
        ...
        assertThat(testAlbum.getSongType()).isEqualTo(DEFAULT_SONG_TYPE);
        assertThat(testAlbum.getTitle()).isEqualTo(DEFAULT_TITLE);
        assertThat(testAlbum.getTimeDuration()).isEqualTo(DEFAULT_TIME_DURATION);
    }
    ...
    void putNewAlbum() throws Exception {
        ...
        updatedAlbum.songType(UPDATED_SONG_TYPE).title(UPDATED_TITLE).timeDuration(UPDATED_TIME_DURATION);
        ...
        Album testAlbum = albumList.get(albumList.size() - 1);
        assertThat(testAlbum.getSongType()).isEqualTo(UPDATED_SONG_TYPE);
        assertThat(testAlbum.getTitle()).isEqualTo(UPDATED_TITLE);
        assertThat(testAlbum.getTimeDuration()).isEqualTo(UPDATED_TIME_DURATION);
    }
    ...
    void partialUpdateAlbumWithPatch() throws Exception {
        ...
        partialUpdatedAlbum.title(UPDATED_TITLE).timeDuration(UPDATED_TIME_DURATION);
    ...
    void fullUpdateAlbumWithPatch() throws Exception {
        ...
        partialUpdatedAlbum.songType(UPDATED_SONG_TYPE).title(UPDATED_TITLE).timeDuration(UPDATED_TIME_DURATION);
